...
import fi.finwe.orion360.sdk.pro.source.OrionImageTexture;
import fi.finwe.orion360.sdk.pro.source.OrionTexture;

public class MinimalActivity extends OrionActivity {
...
//		mPanoramaTexture = OrionTexture.createTextureFromURI(this, "asset://Orion360_test_image_1920x960.jpg");
		...
		if (mPanoramaTexture instanceof OrionImageTexture) {
			((OrionImageTexture)mPanoramaTexture).addTextureListener(new OrionImageTexture.Listener() {
				@Override
				public void onTextureImageUpdated(OrionImageTexture texture) {
					mView.setClearColor(Color.argb(255, 255, 0, 0));
				}
			});
		}
